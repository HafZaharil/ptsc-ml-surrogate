"""
Surrogate modelling for PTSC performance (EffEX)

Trains and evaluates two regression models:
...
- the global best predicted EffEX
- the best predicted EffEX for each Tin = 350..850 (step 50), including the Mhtf that achieves it
"""
...
# ------------------------------------------------------------
# Repo-friendly paths
# - Put your training CSV in: data/train.csv
# - Put your validation CSV (optional) in: data/validation.csv
...
MODEL_PATH_HGB = "/Users/hafzaharil/Downloads/eff_model_hist_gradient_boosting_EffEX.pkl"
MODEL_PATH_XGB = "/Users/hafzaharil/Downloads/eff_model_xgb_EffEX.pkl"
MODEL_PATH_RF  = "/Users/hafzaharil/Downloads/eff_model_rf_EffEX.pkl"
...
# Model training
# ============================================================
def train_hgb_model(df_train: pd.DataFrame):
...
def run_surrogate_max_finder(model, model_name: str):
    ...
    while True:
        ...
        print(f"Predicted_EffEX: {best['Predicted_EffEX']:.6f}")
...
if __name__ == "__main__":
    ...
    if os.path.exists(MODEL_PATH_HGB):
        ...
        reg_hgb = train_hgb_model(df_train)
