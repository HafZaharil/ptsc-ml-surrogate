...
VALIDATION_PATH = os.path.join(REPO_ROOT, "data", "validation.csv")  # optional

MODEL_PATH_HGB = os.path.join(REPO_ROOT, "models", "model_hgb_Eff.pkl")
MODEL_PATH_XGB = os.path.join(REPO_ROOT, "models", "model_xgb_Eff.pkl")
